...
**127 tests, all passing**, run against a real PostgreSQL database using the same migration files as production — not mocks.
...
| `whatsapp.test.ts` | 35 | Plain-text formatting, inbound flow, two-way delivery, idempotency |
